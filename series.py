...
SERIE_URL = "https://m.prectv52.lol/api/serie/by/filtres/0/created/{page}/4F5A9C3D9A86FA54EACEDDD635185/c3c5bd17-e37b-4b94-a944-8a3688a30452/"
EPISODE_URL_TEMPLATE = "https://m.prectv52.lol/api/season/by/serie/{id}/4F5A9C3D9A86FA54EACEDDD635185/c3c5bd17-e37b-4b94-a944-8a3688a30452/"
...
def extract_serie_links(series):
    ...
    for serie in series:
        ...
        year = serie.get("year", "")
        group = title  # group-title'ı dizinin ismiyle doldurduk
